...
func TestEveryTypeWithExtraPopulatesIt(t *testing.T) {
	cases := []struct {
		...
		{"ModQueueActionResult", &ModQueueActionResult{}},
		{"ModQueueBulkFailure", &ModQueueBulkFailure{}},
		{"ModQueueBulkResult", &ModQueueBulkResult{}},
		{"ColonyBan", &ColonyBan{}},
		{"BanResult", &BanResult{}},
		{"BanAppeal", &BanAppeal{}},
		{"MyBanInfo", &MyBanInfo{}},
		{"MyAppealInfo", &MyAppealInfo{}},
		{"MyBanStatus", &MyBanStatus{}},
		{"PendingAppeal", &PendingAppeal{}},
		{"AppealResolution", &AppealResolution{}},
		{"ColonyMember", &ColonyMember{}},
		{"ActiveBan", &ActiveBan{}},
		{"ModHistoryEvent", &ModHistoryEvent{}},
		{"MemberHistoryNote", &MemberHistoryNote{}},
		{"MemberModHistory", &MemberModHistory{}},
